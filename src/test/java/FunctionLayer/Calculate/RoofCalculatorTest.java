...
public class RoofCalculatorTest {
    ...
    public void topRoofPostHeight480x480() throws GeneralException, MakeOrderException {
        ...
        //Act
        Carport result = cc.calculateAll(length, width, true, shed);
        int expectedRoofPostHeight = 548;
        int actualRoofPostHeight = (int) result.getRoofPostHeight();
        //Assert
        Assert.assertEquals(expectedRoofPostHeight, actualRoofPostHeight);
    }
    ...
    public void topRoofPostHeight720x720() throws GeneralException, MakeOrderException {
        ...
        //Act
        Carport result = cc.calculateAll(length, width, true, shed);
        int expectedRoofPostHeight = 788;
        int actualRoofPostHeight = (int) result.getRoofPostHeight();
        //Assert
        Assert.assertEquals(expectedRoofPostHeight, actualRoofPostHeight);
    }
    ...
    public void topRoofRafterLength480x480() throws GeneralException, MakeOrderException {
        ...
        //Act
        Carport result = cc.calculateAll(length, width, true, shed);
        int expectedRoofRafterLength = 613;
        int actualRoofRafterLength = (int) result.getRoofRafterLength();
        //Assert
        Assert.assertEquals(expectedRoofRafterLength, actualRoofRafterLength);
    }
    ...
    public void topRoofRafterLength720x720() throws GeneralException, MakeOrderException {
        ...
        //Act
        Carport result = cc.calculateAll(length, width, true, shed);
        int expectedRoofRafterLength = 881;
        int actualRoofRafterLength = (int) result.getRoofRafterLength();
        //Assert
        Assert.assertEquals(expectedRoofRafterLength, actualRoofRafterLength);
    }
