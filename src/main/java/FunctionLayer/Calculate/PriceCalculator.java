...
public class PriceCalculator {
    ...
    /**
     * This method calculates the price of the carport. It takes the parameters
     * of the caport and calls the calculator to calculate the carport. It then
     * calls the material calculator to calculate the materials used for the
     * carport just calculated. finally it runs through the carport list of
     * materials to calculate the overall price.
     *
     ...
     * @param roof this is a boolean that shows if the roof should be flat or
     * high
     * @param shed this is a boolean that shows if the carport should be
     * calculated width or widthout a shed
     * @return This method returns the overall price for the carport as a
     * boolean
     * @throws DMException it throws this exception if there is any problems
     * with the data mapper method/SQL calling
