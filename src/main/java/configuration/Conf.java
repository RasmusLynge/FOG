...
//    public static final String LOGFILEPATH = "/var/log/tomcat8/App.log";
...
//            } else {
//                try {
//                    FileHandler handler = new FileHandler("logging-log.%u.%g.txt"); // see: http://tutorials.jenkov.com/java-logging/handlers.html
//                    handler.setFormatter(new VerySimpleFormatter());
//                    logger.addHandler(handler);
//                } catch (IOException ex) {
